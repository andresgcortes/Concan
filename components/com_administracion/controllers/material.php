...
class AdministracionControllerMaterial extends JControllerForm{	
    ...
    function save($key = NULL, $urlVar = NULL){
		...
		if ($return === false) {
			...
			$app->setUserState('com_administracion.area.global.data', $data);

			// Redirect back to the edit screen.
			$this->setRedirect(JRoute::_('index.php?option=com_administracion&view=materiales&layout=edit', false));
		...
		switch ($this->getTask()){
			...
			case 'apply':
				...
				$message = JText::_('Material Guardado Correctamente');
				$this->setRedirect(JRoute::_('index.php?option=com_administracion&view=materiales&layout=edit&id='.$model->GetState('material.id')), $message);
			break;
