...
<script src="<?php echo $this->baseurl ?>/templates/protostar/assets/js/scripts.js" type="text/javascript"></script>
		...
		<section class="box">
        	...
        	<div class="content-body" style="display: block">			
				...
				<div class="row">
					...
					<div class="form-group col-xs-3">                                        
						<?php echo $this->form->getLabel('tipo'); ?>
						<div class="controls">
							<?php echo $this->form->getInput('tipo'); ?>
						</div>
					</div>
