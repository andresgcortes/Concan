        ...
        <div class="content-body"> 
        	...
        	<div class="row">
            	<div class="col-md-12 col-sm-12 col-xs-12">
                	...
                	<form action="<?php echo JRoute::_('index.php?option=com_operacion&view=facturacion'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal">
									...
									<tbody id="sortable">
										...
										<?php foreach ($this->items as $i => $item){
											...
											<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id; ?>" itemid ="1">
												...
												<td>
													<a href="index.php?option=com_operacion&view=facturacion&layout=edit&id=<?php echo $item->id ?>" >
														<?php echo $item->id ?>
													</a>
												</td>
												...
												<td>
													...
													<?php echo $item->estado_pedido ?>

												</td>

												<td>

													<?php echo $item->estado_facturacion ?>
