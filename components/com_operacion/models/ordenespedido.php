...
class OperacionModelOrdenesPedido extends JModelList{
	...
	public function getItems(){
		...
		foreach($items as $key => $item){
			...
			$query->select('a.*, b.nombre as cliente, c.nombre as tipoorden, d.placa as placa, e.nombre AS estado_pedido, f.nombre AS estado_facturacion');
			...
			$query->where('a.id_parent = '. $item->id);
			$db->setQuery($query);			
			$items[$key]->novedades = $db->loadObjectList();	
