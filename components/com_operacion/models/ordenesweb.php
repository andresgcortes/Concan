...
class OperacionModelOrdenesWeb extends JModelList{
	...
	function getListQuery(){
		...
		$query->select(
			$this->getState('list.select', 'a.*, b.nombre as cliente, c.nombre as tipoorden, d.placa as placa, e.nombre AS estado_pedido')
		);

		$query->from('#__operacion_ordenes_web AS a');
