...
class OperacionControllerOrdenesPedido extends JControllerForm{	
    ...
    function save($key = NULL, $urlVar = NULL){
		...
		if ($return === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_operacion&view=ordenespedido&layout=edit', false));
		...
		switch ($this->getTask()){
			...
			case 'apply':
				...
				$this->setRedirect(JRoute::_('index.php?option=com_operacion&view=ordenespedido&layout=edit&id='.$model->GetState('ordnespedido.id')), $message);
				break;
